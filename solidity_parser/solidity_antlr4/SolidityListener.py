...
class SolidityListener(ParseTreeListener):
    ...
    def enterUsingForObjectDirective(
        self, ctx: SolidityParser.UsingForObjectDirectiveContext
    ):
        pass

    # Exit a parse tree produced by SolidityParser#usingForObjectDirective.
    def exitUsingForObjectDirective(
        self, ctx: SolidityParser.UsingForObjectDirectiveContext
    ):
        pass

    # Enter a parse tree produced by SolidityParser#userDefinableOperators.
    def enterUserDefinableOperators(
        self, ctx: SolidityParser.UserDefinableOperatorsContext
    ):
        pass

    # Exit a parse tree produced by SolidityParser#userDefinableOperators.
    def exitUserDefinableOperators(
        self, ctx: SolidityParser.UserDefinableOperatorsContext
    ):
        pass
    ...
    def enterInlineAssemblyStatementFlag(
        self, ctx: SolidityParser.InlineAssemblyStatementFlagContext
    ):
        pass

    # Exit a parse tree produced by SolidityParser#inlineAssemblyStatementFlag.
    def exitInlineAssemblyStatementFlag(
        self, ctx: SolidityParser.InlineAssemblyStatementFlagContext
    ):
        pass
